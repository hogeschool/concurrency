...
### Practical notes:
1. The exercises of each week corresponds to some of the source codes available here in Github: [https://github.com/afshinamighi/Courses](https://github.com/hogeschool/concurrency)
